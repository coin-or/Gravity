...
#define DebugOff(x)
    ...
    typedef enum { id_, plus_, minus_, product_, div_, power_, cos_, sin_, sqrt_, exp_, log_, tan_, acos_, asin_, atan2_, relu_, unit_step_, min_, max_} OperatorType;  /* Operation type in the expression tree */
