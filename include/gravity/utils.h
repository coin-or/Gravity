...
void initialize_basis_vectors(gravity::SolverType stype, std::vector<std::vector<double>>& vbasis,std::vector<std::vector<double>>& cbasis, const std::vector<double>& vrbasis, const std::vector<double>& crbasis, int nb_threads);
void get_row_scaling(const std::vector<double>& c_val, double& scale, bool& oa_cut, const double zero_tol, const double min_coef);
