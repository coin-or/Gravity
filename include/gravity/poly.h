    ...
    //        };
            ...
            lterm(const shared_ptr<constant_>& coef, const shared_ptr<param_>& p):lterm(true,coef,p){};
            
            lterm(bool sign, const shared_ptr<constant_>& coef, const shared_ptr<param_>& p);
    ...
    //        qterm(shared_ptr<param_> p1, shared_ptr<param_> p2):qterm(true, p1, p2){};
            ...
            qterm(const shared_ptr<constant_>& coef, const shared_ptr<param_>& p1, const shared_ptr<param_>& p2):qterm(true, coef, p1, p2){};
            
    //        qterm(bool sign, shared_ptr<param_> p1, shared_ptr<param_> p2):qterm(true, unit<type>(), p1, p2){};
            
            qterm(bool sign, const shared_ptr<constant_>& coef, const shared_ptr<param_>& p1, const shared_ptr<param_>& p2){
                _coef = coef;
