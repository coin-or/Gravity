...
typedef enum { binary_, short_, integer_, float_, double_, long_, fixed_} VarType;
typedef enum { binary_p, short_p, integer_p, float_p, double_p, long_p} ParamType;
typedef enum { binary_c, short_c, integer_c, float_c, double_c, long_c, parameter, unary_exp, binary_exp} ConstType;
