...
namespace gravity {
    ...
    public:
        ...
        std::tuple<bool,int,double,double,double,bool> run_obbt(double max_time = 1000, unsigned max_iter=1e3, const pair<bool,double>& upper_bound = make_pair<bool,double>(false,0), unsigned precision=6, Model<type> ub_model= nullptr, Model<type> nonlin_model= nullptr, bool nonlin=true);
