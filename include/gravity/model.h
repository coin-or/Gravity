...
//        vector<shared_ptr<Constraint_>>              _cons_vec;
//        map<size_t, shared_ptr<Constraint_>>       _cons; /**< Sorted map (increasing index) pointing to all Constraint_s contained in this model */
//        map<string, shared_ptr<Constraint_>>         _cons_name; /**< Sorted map (increasing index) pointing to all Constraint_s contained in this model */
//        map<unique_id, set<Constraint_*>>  _v_in_cons; /**< Set of constraints where each variable appears */
//
...
//
//        
//        shared_ptr<Constraint_> get_constraint(const string& name) const;
//        
...
//        void add_lazy(const Constraint_& c);
//        void add(const Constraint_& c);
...
//        shared_ptr<Constraint_> add_constraint(const Constraint_& c);
//        
//        
...
//        void del_constraint(const Constraint_& c);
...
//    #endif        
//        void add_on_off(const Constraint_& c, var<bool>& on);
