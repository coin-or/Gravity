...
//        }
        ...
        void add_iterative(const Model<type>& interior, vector<double>& obbt_solution, shared_ptr<Model<>> lin, std::string model_name,int& oacuts, double active_tol);
        int num_obbt_prob(){
            int count=0;
            for(auto &v:_vars){
