...
#include <gravity/jly_sorting.hpp>
...
double GoICP::ICP(Matrix& R_icp, Matrix& t_icp)
{
  int i;
	double error, dis;
	...
	if(doTrim)
	{
		//qsort(minDis, Nd, sizeof(double), cmp);
