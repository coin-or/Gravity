...
//  Gravity
//  interface for SDPA
//  borrow ingredients from scipsdp-3.0.0/src/sdpi/sdpisolver_sdpa.cpp
...
#include "Sdpa.h"
/* #define SDPA_DEBUG*/
/* #define SDPA_MORE_DEBUG   *//* shows all added nonzero entries */
/* #define SDPA_DEBUG_PRINTTOFILE  *//* prints each problem inserted into SDPA to the file sdpa.dat-s and the starting point to sdpa.ini-s */
...
#include <sdpa/sdpa_call.h>  /* SDPA callable library interface */
