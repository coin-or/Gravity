...
// ****************************
//
//  double functions BEGIN
//
// ****************************
double MINforward3Ddouble(Array3dDEucl3D& A, double d1,double d2,double d3,int z,int y,int x){
  DEucl3D*** inDE = A.data;
  int Xdim = A.Xdim;
  int Ydim = A.Ydim;
  int Zdim = A.Zdim;
...
double MINbackward3Ddouble(Array3dDEucl3D& A, double d1,double d2,double d3,int z,int y,int x){
  DEucl3D*** inDE = A.data;
  int Xdim = A.Xdim;
  int Ydim = A.Ydim;
  int Zdim = A.Zdim;
...
void DistanceTransform3Ddouble(Array3dDEucl3D& A, double d1,double d2,double d3){
  DEucl3D*** inDE = A.data;
  int Xdim = A.Xdim;
  int Ydim = A.Ydim;
  int Zdim = A.Zdim;
