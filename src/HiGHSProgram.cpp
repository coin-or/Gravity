...
HiGHSProgram::HiGHSProgram(){
//    model = m;
//    Highs_inst = make_shared<Highs>();
...
HiGHSProgram::HiGHSProgram(const shared_ptr<Model<>>& m) {
//    grb_env = new GRBEnv();
//    grb_env->set(GRB_IntParam_Presolve,0);
//    //grb_env->set(GRB_DoubleParam_NodeLimit,1);
//    grb_env->set(GRB_DoubleParam_TimeLimit,7200);
...
void HiGHSProgram::prepare_model(){
//    _model->fill_in_maps();
...
void HiGHSProgram::update_model(){
//    _model->fill_in_maps();
//    _model->compute_funcs();
//    fill_in_grb_vmap();
//    create_grb_constraints();
...
void HiGHSProgram::update_solution(){
//    size_t vid, vid_inst;
//    GRBVar gvar;
//    param_* v;
...
void HiGHSProgram::fill_in_var_map(){
//    param_* v;
...
void HiGHSProgram::create_constraints(){
//    char sense;
...
//        c->_new = false;
//        if (c->is_nonlinear()) {
//            throw invalid_argument("HiGHS cannot handle nonlinear constraints that are not convex quadratic.\n");
//        }
//        switch(c->get_ctype()) {
//            case geq:
...
void HiGHSProgram::set_objective(){
//    size_t idx = 0;
//    GRBLinExpr lterm;
//    GRBQuadExpr qobj;
//    GRBVar gvar1, gvar2;
...
void HiGHSProgram::print_constraints(){
