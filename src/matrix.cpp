...
namespace Go_ICP
{
    ...
    bool Matrix::lu(int32_t *idx, FLOAT &d, FLOAT eps) {
      ...
      FLOAT* vv = (FLOAT*)std::malloc(n*sizeof(FLOAT)); // vv stores the implicit scaling of each row.
      d = 1.0;
    ...
    void Matrix::svd(Matrix &U2,Matrix &W,Matrix &V) {
      ...
      FLOAT* w   = (FLOAT*)std::malloc(n*sizeof(FLOAT));
      FLOAT* rv1 = (FLOAT*)std::malloc(n*sizeof(FLOAT));
      ...
      int32_t s2,inc=1;
      FLOAT   sw;
      FLOAT* su = (FLOAT*)std::malloc(m*sizeof(FLOAT));
      FLOAT* sv = (FLOAT*)std::malloc(n*sizeof(FLOAT));
    ...
    void Matrix::allocateMemory (const int32_t m_,const int32_t n_) {
      ...
      val    = (FLOAT**)std::malloc(m*sizeof(FLOAT*));
      val[0] = (FLOAT*)std::calloc(m*n,sizeof(FLOAT));
