...
find_package_handle_standard_args(CPLEX DEFAULT_MSG CPLEX_CPP_LIBRARY CPLEX_DIST_CPP_LIBRARY CPLEX_ILO_CPP_LIBRARY CONCERT_CPP_LIBRARY  CPLEX_INCLUDE_DIR CONCERT_INCLUDE_DIR CPLEX_LINK)

if(CPLEX_FOUND)
    set(CPX_LICENSE_FILE "~/cplex.research.lic")
    set(CPLEX_INCLUDE_DIRS ${CPLEX_INCLUDE_DIR}/.. ${CONCERT_INCLUDE_DIR}/..)
    set(CPLEX_LIBRARIES ${CPLEX_CPP_LIBRARY} ${CPLEX_DIST_CPP_LIBRARY} ${CPLEX_ILO_CPP_LIBRARY} ${CONCERT_CPP_LIBRARY})
    set(CPLEX_LINKS ${CPLEX_LINK}/)
