...
//        SDP3.print_expanded();
    ...
    SOC1 = power(R_Wij("1,2"), 2) + power(Im_Wij("1,2"), 2) - Wii("1")*Wii("2");
    SDP.add(SOC1 == 0);
    
    Constraint SOC2("SOC2");
    SOC2 = power(R_Wij("1,3"), 2) + power(Im_Wij("1,3"), 2) - Wii("1")*Wii("3");
//    SDP.add(SOC2 == 0);
    
    Constraint SOC3("SOC3");
    SOC3 = power(R_Wij("2,3"), 2) + power(Im_Wij("2,3"), 2) - Wii("2")*Wii("3");
    SDP.add(SOC3 == 0);
