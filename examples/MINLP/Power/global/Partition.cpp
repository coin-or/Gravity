...
Partition::Partition(int Num_parts){
//    bag_bus.resize(Num_parts);
//    bag_arcs_out.resize(Num_parts);
//    bag_gens.resize(Num_parts);
//    bag_arcs_disjoint.resize(Num_parts);
//    bag_arcs_neighbour.resize(Num_parts);
//    bag_arcs_in.resize(Num_parts);
//    bag_arcs_out.resize(Num_parts);
//    bag_arcs_union.resize(Num_parts);
//    bag_arcs_union_in.resize(Num_parts);
//    bag_arcs_union_out.resize(Num_parts);
}
Partition::~Partition() {};
