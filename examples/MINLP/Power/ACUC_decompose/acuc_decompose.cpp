...
int main (int argc, const char * argv[])
{
    ...
    for (int c = 0; c < nbparts; c++) {
        ...
        ACUC.add_var(bag_Xii.var::in(P.bag_bus_union_out[c], T));
        ...
        ACUC.add_var(bag_R_Xij.in(P.bag_bus_pairs_union[c], T));
        ACUC.add_var(bag_Im_Xij.in(P.bag_bus_pairs_union[c], T));
...
//            Constraint Production_Q_UB("Production_Q_UB_"+ to_string(c));
//            // 5A
//            Production_P_UB = Pg[c].in(P.bag_gens[c], T) - grid.pg_max.in(P.bag_gens[c], T);
//            Production_P_LB = Pg[c].in(P.bag_gens[c], T) - grid.pg_min.in(P.bag_gens[c], T);
//            ACUC.add_constraint(Production_P_UB <=0);
//            ACUC.add_constraint(Production_P_LB >= 0);
//
//            Production_Q_UB = Qg[c].in(P.bag_gens[c], T) - grid.qg_max.in(P.bag_gens[c], T);
//            Production_Q_LB = Qg[c].in(P.bag_gens[c], T) - grid.qg_min.in(P.bag_gens[c], T);
//            ACUC.add_constraint(Production_Q_UB <= 0);
//            ACUC.add_constraint(Production_Q_LB >= 0);
//        }
//    }
