...
int main (int argc, const char * argv[])
{
    ...
    std::cout << "Print the total " << spanning_tree.size() << " edges in the MST:" << std::endl;
    ...
    /** create the main problem model */
    /** Use in-out algorithm */
    Model Master("Master");
    ...
    Subr.add_var(Pg^(T*nb_gen));
    Subr.add_var(Qg^(T*nb_gen));
