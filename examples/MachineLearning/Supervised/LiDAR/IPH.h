    ...
    if(!bypass){
        ...
        for (auto i = 0; i<point_cloud1.size(); i++) {
            ...
            if(nb_neighbors[i]>=nb_max_neigh){
                ...
                pitch_ins1.add_val(i_str, (-pi+rollpitchyawins1.at(i)[1])*(-1));
                yaw_ins1.add_val(i_str, (-pi/2+rollpitchyawins1.at(i)[2])*(-1));
                auto res_s=apply_rotation_inverse_new_order(rollpitchyawins1.at(i)[0], rollpitchyawins1.at(i)[1], (-pi/2+rollpitchyawins1.at(i)[2])*(-1), scanner_x, scanner_y, scanner_z);
                auto res_d=apply_rotation_new_order(rollpitchyawins1.at(i)[0], (-pi+rollpitchyawins1.at(i)[1])*(-1), (-pi/2+rollpitchyawins1.at(i)[2])*(-1), point_cloud1.at(i)[0]-uav1.at(i)[0]-res_s[0], point_cloud1.at(i)[1]-uav1.at(i)[1]-res_s[1], point_cloud1.at(i)[2]-uav1.at(i)[2]-res_s[2]);
                x1i.add_val(i_str,res_d[0]);
                y1i.add_val(i_str,res_d[1]);
                z1i.add_val(i_str,res_d[2]);
                ...
                for (auto j = 0; j<nb_max_neigh; j++) {
                    ...
                    if(res==n2_map.end()){
                        ...
                        pitch_ins2.add_val(j_str, (-pi+rollpitchyawins2.at(k)[1])*(-1));
                        yaw_ins2.add_val(j_str, (-pi/2+rollpitchyawins2.at(k)[2])*(-1));
                        auto res_s=apply_rotation_inverse_new_order(rollpitchyawins2.at(k)[0], rollpitchyawins2.at(k)[1], (-pi/2+rollpitchyawins2.at(k)[2])*(-1), scanner_x, scanner_y, scanner_z);
                        auto res_m=apply_rotation_new_order(rollpitchyawins2.at(k)[0], (-pi+rollpitchyawins2.at(k)[1])*(-1), (-pi/2+rollpitchyawins2.at(k)[2])*(-1), point_cloud2.at(k)[0]-uav2.at(k)[0]-res_s[0], point_cloud2.at(k)[1]-uav2.at(k)[1]-res_s[1], point_cloud2.at(k)[2]-uav2.at(k)[2]-res_s[2]);
                        x2i.add_val(j_str,res_m[0]);
                        y2i.add_val(j_str,res_m[1]);
                        z2i.add_val(j_str,res_m[2]);
...
tuple<double,double,double> run_NLP_scanner_old(string axis, const vector<vector<double>>& point_cloud1, const vector<vector<double>>& point_cloud2, const vector<vector<double>>& uav1, const vector<vector<double>>& uav2, const vector<vector<double>>& rollpitchyawins1, const vector<vector<double>>& rollpitchyawins2)
{
    ...
    if(!bypass){
        ...
        if (solve_lidar_iter) {
            ...
            Lidar.add(yaw.in(range(0,0)),pitch.in(range(0,0)),roll.in(range(0,0)));
            Lidar.add(sx.in(range(0,0)),sy.in(range(0,0)),sz.in(range(0,0)));
            Lidar.add(new_x1.in(N1), new_y1.in(N1), new_z1.in(N1));
            Lidar.add(new_x2.in(N2), new_y2.in(N2), new_z2.in(N2));
            Lidar.add(xb_d.in(N1), yb_d.in(N1), zb_d.in(N1));
            Lidar.add(xb_m.in(N2), yb_m.in(N2), zb_m.in(N2));
            ...
            Lidar.add(xs_m.in(N1), ys_m.in(N1), zs_m.in(N1));
            
            var<> xs_d("xs_d"), ys_d("ys_d"), zs_d("zs_d");
            Lidar.add(xs_d.in(N1), ys_d.in(N1), zs_d.in(N1));
            ...
            Constraint<> xd_bore("xd_bore");
            xd_bore=(x1i.in(N1)-sx.in(ids1)) *theta11.in(ids1)+(y1i.in(N1)-sy.in(ids1))*theta12.in(ids1)+(z1i.in(N1)-sz.in(ids1))*theta13.in(ids1)-xb_d.in(N1);
            Lidar.add(xd_bore.in(N1)==0);
            
            Constraint<> xm_bore("xm_bore");
            xm_bore=(x2i.in(N2)-sx.in(ids2))*theta11.in(ids2)+(y2i.in(N2)-sy.in(ids2))*theta12.in(ids2)+(z2i.in(N2)-sz.in(ids2))*theta13.in(ids2)-xb_m.in(N2);
            Lidar.add(xm_bore.in(N2)==0);
            
            Constraint<> yd_bore("yd_bore");
            yd_bore=(x1i.in(N1)-sx.in(ids1))*theta21.in(ids1)+(y1i.in(N1)-sy.in(ids1))*theta22.in(ids1)+(z1i.in(N1)-sz.in(ids1))*theta23.in(ids1)-yb_d.in(N1);
            Lidar.add(yd_bore.in(N1)==0);
            
            Constraint<> ym_bore("ym_bore");
            ym_bore=(x2i.in(N2)-sx.in(ids2))*theta21.in(ids2)+(y2i.in(N2)-sy.in(ids2))*theta22.in(ids2)+(z2i.in(N2)-sz.in(ids2))*theta23.in(ids2)-yb_m.in(N2);
            Lidar.add(ym_bore.in(N2)==0);
            
            Constraint<> zd_bore("zd_bore");
            zd_bore=(x1i.in(N1)-sx.in(ids1))*theta31.in(ids1)+(y1i.in(N1)-sy.in(ids1))*theta32.in(ids1)+(z1i.in(N1)-sz.in(ids1))*theta33.in(ids1)-zb_d.in(N1);
            Lidar.add(zd_bore.in(N1)==0);
            
            Constraint<> zm_bore("zm_bore");
            zm_bore=(x2i.in(N2)-sx.in(ids2))*theta31.in(ids2)+(y2i.in(N2)-sy.in(ids2))*theta32.in(ids2)+(z2i.in(N2)-sz.in(ids2))*theta33.in(ids2)-zb_m.in(N2);
            Lidar.add(zm_bore.in(N2)==0);
            
            Constraint<> xs_ins_inv1("xs_ins_inv1");
            xs_ins_inv1=sx*cos(roll_ins1)*cos(yaw_ins1)+sy*(cos(pitch_ins1)*sin(yaw_ins1) +cos(yaw_ins1)*sin(roll_ins1)*sin(pitch_ins1))+sz*(sin(pitch_ins1)*sin(yaw_ins1)-cos(pitch_ins1)*cos(yaw_ins1)*sin(roll_ins1))-xs_d;
            Lidar.add(xs_ins_inv1.in(N1)==0);
            
            Constraint<> ys_ins_inv1("ys_ins_inv1");
            ys_ins_inv1=sx*(-1)*cos(roll_ins1)*sin(yaw_ins1)+sy*(cos(pitch_ins1)*cos(yaw_ins1) -sin(roll_ins1)*sin(pitch_ins1)*sin(yaw_ins1))+sz*(cos(yaw_ins1)*sin(pitch_ins1)+cos(pitch_ins1)*sin(roll_ins1)*sin(yaw_ins1))-ys_d;
            Lidar.add(ys_ins_inv1.in(N1)==0);
            
            Constraint<> zs_ins_inv1("zs_ins_inv1");
            zs_ins_inv1=sx*sin(roll_ins1)+sy*(-1)*cos(roll_ins1)*sin(pitch_ins1)+sz*(cos(roll_ins1)*cos(pitch_ins1))-zs_d;
            Lidar.add(zs_ins_inv1.in(N1)==0);
   
            Constraint<> xs_ins_inv2("xs_ins_inv2");
            xs_ins_inv2=sx*cos(roll_ins2)*cos(yaw_ins2)+sy*(cos(pitch_ins2)*sin(yaw_ins2) +cos(yaw_ins2)*sin(roll_ins2)*sin(pitch_ins2))+sz*(sin(pitch_ins2)*sin(yaw_ins2)-cos(pitch_ins2)*cos(yaw_ins2)*sin(roll_ins2))-xs_m;
            Lidar.add(xs_ins_inv2.in(N2)==0);
                
            Constraint<> ys_ins_inv2("ys_ins_inv2");
            ys_ins_inv2=sx*(-1)*cos(roll_ins2)*sin(yaw_ins2)+sy*(cos(pitch_ins2)*cos(yaw_ins2) -sin(roll_ins2)*sin(pitch_ins2)*sin(yaw_ins2))+sz*(cos(yaw_ins2)*sin(pitch_ins2)+cos(pitch_ins2)*sin(roll_ins2)*sin(yaw_ins2))-ys_m;
            Lidar.add(ys_ins_inv2.in(N2)==0);
            
            Constraint<> zs_ins_inv2("zs_ins_inv2");
            zs_ins_inv2=sx*sin(roll_ins2)+sy*(-1)*cos(roll_ins2)*sin(pitch_ins2)+sz*(cos(roll_ins2)*cos(pitch_ins2))-zs_m;
            Lidar.add(zs_ins_inv2.in(N2)==0);
            if(axis!="x"){
                
Constraint<> x_rot1("x_rot1");
x_rot1 += new_x1 - x_uav1.in(N1)-xs_d;
x_rot1 -= xb_d*cos(roll_ins1)*cos(yaw_ins1)+yb_d*(cos(pitch_ins1)*sin(yaw_ins1) +cos(yaw_ins1)*sin(roll_ins1)*sin(pitch_ins1))+zb_d*(sin(pitch_ins1)*sin(yaw_ins1)-cos(pitch_ins1)*cos(yaw_ins1)*sin(roll_ins1));
Lidar.add(x_rot1.in(N1)==0);
                
Constraint<> x_rot2("x_rot2");
x_rot2 += new_x2 - x_uav2.in(N2)-xs_m;
x_rot2 -= xb_m*cos(roll_ins2)*cos(yaw_ins2)+yb_m*(cos(pitch_ins2)*sin(yaw_ins2) +cos(yaw_ins2)*sin(roll_ins2)*sin(pitch_ins2))+zb_m*(sin(pitch_ins2)*sin(yaw_ins2)-cos(pitch_ins2)*cos(yaw_ins2)*sin(roll_ins2));
Lidar.add(x_rot2.in(N2)==0);
            }
            ...
            if(axis!="y"){
                ...
                Constraint<> y_rot1("y_rot1");
                y_rot1 += new_y1 - y_uav1.in(N1)-ys_d;
                y_rot1 -= xb_d*(-1)*cos(roll_ins1)*sin(yaw_ins1)+yb_d*(cos(pitch_ins1)*cos(yaw_ins1) -sin(roll_ins1)*sin(pitch_ins1)*sin(yaw_ins1))+zb_d*(cos(yaw_ins1)*sin(pitch_ins1)+cos(pitch_ins1)*sin(roll_ins1)*sin(yaw_ins1));
                Lidar.add(y_rot1.in(N1)==0);

                
                Constraint<> y_rot2("y_rot2");
                y_rot2 += new_y2 - y_uav2.in(N2)-ys_m;
                y_rot2 -= xb_m*(-1)*cos(roll_ins2)*sin(yaw_ins2)+yb_m*(cos(pitch_ins2)*cos(yaw_ins2) -sin(roll_ins2)*sin(pitch_ins2)*sin(yaw_ins2))+zb_m*(cos(yaw_ins2)*sin(pitch_ins2)+cos(pitch_ins2)*sin(roll_ins2)*sin(yaw_ins2));
                Lidar.add(y_rot2.in(N2)==0);
            }
            ...
            if(axis!="z"){
                ...
                Constraint<> z_rot1("z_rot1");
                z_rot1 += new_z1 - z_uav1.in(N1)-zs_d;
                z_rot1 -= xb_d*sin(roll_ins1)+yb_d*(-1)*cos(roll_ins1)*sin(pitch_ins1)+zb_d*(cos(roll_ins1)*cos(pitch_ins1));
                Lidar.add(z_rot1.in(N1)==0);
                
                Constraint<> z_rot2("z_rot2");
                z_rot2 += new_z2 - z_uav2.in(N2)-zs_m;
                z_rot2 -= xb_m*sin(roll_ins2)+yb_m*(-1)*cos(roll_ins2)*sin(pitch_ins2)+zb_m*(cos(roll_ins2)*cos(pitch_ins2));
                Lidar.add(z_rot2.in(N2)==0);
            }
           ...
           // Lidar.print_solution();
            ...
            DebugOn("sx " << sx.eval() << endl);
            DebugOn("sy " << sy.eval() << endl);
            DebugOn("sz " << sz.eval() << endl);
