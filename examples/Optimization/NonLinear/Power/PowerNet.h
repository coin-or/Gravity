...
public:
    ...
    param<double> r,x,g, b, ch, tr, inv_tr, as, S_max, wr_min, wr_max, wi_min, wi_max, cc, dd; /**< Power lines parameters, resp., impedance, line charging, and thermal limits. w params are for lifted variavles in W space */
...
shared_ptr<Model<>> build_ACOTS(PowerNet& grid, PowerModelType Model=ACPOL, int output=0, double tol=1e-6);
